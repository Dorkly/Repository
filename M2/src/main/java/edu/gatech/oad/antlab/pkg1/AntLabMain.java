 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Bryanna Lawton");
		  toPrint += p1.toString("blawton6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2(" Jim Helm");
		  toPrint += p2.toString("jhelm6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Youngsun Park");
		  toPrint += p3.toString("ypark3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Austin Jiang");
                  toPrint += p4.toString("hjiang74");
